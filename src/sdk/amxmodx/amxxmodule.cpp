...
#ifdef AMXX_GIVEFNPTRS_WINAPI
// simplified calling convention for Windows builds where the original
// naked+__asm prolog/epilog approach is problematic with this toolchain
...
#if !defined(AMXX_GIVEFNPTRS_WINAPI) && defined(_MSC_VER)
	// Epilog
	if (sizeof(int*) == 8)
	{	// 64 bit
		__asm
...
#endif // !AMXX_GIVEFNPTRS_WINAPI && _MSC_VER
}
